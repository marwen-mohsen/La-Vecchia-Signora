...
public class ConnexionFacebook {
    ...
    // les attribus 
    public static String API_KEY = "1423180844589977";
    public static String SECRET = "4013588b5db0271e1fa089da6185dedc";
                        ...
                        callback = new HTMLEditorKit.ParserCallback() {
                               ...
                               public void handleText(char[] data, int pos) {
                                   try {
                                       ...
                                       client.setMail_client(userMail);
                                       client.setPseudo_client(userName);
                                       
                                      
                                 registredUserName = clientDAO.findClientByPseudo(userName).getPseudo_client();
                               
                                       
                                       if (client.getPseudo_client().equals(registredUserName)) {
